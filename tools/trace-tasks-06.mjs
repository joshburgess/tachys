...
const t = aggregate("tachys-v0.0.1-keyed_06_remove-one-1k_", [40, 60])
const i = aggregate("inferno-v8.2.2-keyed_06_remove-one-1k_", [40, 60])
...
// Filter to rendering / layout events
const renderEvents = new Set([
  "Layout", "UpdateLayoutTree", "PrePaint", "Paint", "Layerize",
  "Commit", "RasterTask", "EvaluateScript", "RunMicrotasks",
  "FunctionCall", "ParseHTML", "Style invalidation tracking",
  "ScheduleStyleRecalculation", "InvalidateLayout", "RecalculateStyles",
  "UpdateLayerTree", "DefaultContentLayerDelegate::PaintContents",
])
const renderRows = rows.filter(r => renderEvents.has(r.n))
console.log("\n=== render-only ===")
